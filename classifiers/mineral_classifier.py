...
class MineralClassfier:
    ...
    def __init__(self, image, median_filtering_mode):
        ...
        self.run(self.ratioing_window_size, self.M_highest_slogs, self.median_filter_window_size, self.median_filtering_mode)
    ...
    def update_median_filtering_mode(self, mode):
        ...
        self.update_median_filtering_parameters(self.median_filter_window_size)
...
if __name__ == "__main__":
    ...
    classifier = MineralClassfier(img, 0)
