...
class MineralClassfier:
    ...
    '''
    def neutral_pixel_classification(self, window_size):
    ...
    def mineral_classification(self):
        ...
        #TODO: need to rework this so use the correct image input
        classifier_ouput = self.two_layer_gmm(self.neutral_image, model.Sig_s, model.mu_s, model.v_s, model.class_id)

        return ClassificationMap(classifier_ouput[2])
